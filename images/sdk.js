	...
	this.createBox = function() {
		...
		var html =
			"<style>\n"
				...
				+ (this.forceStyles ? "#" : ".") + this.prefix + "chat { width:83%;min-height:40px; }\n"
